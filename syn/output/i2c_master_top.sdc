...
# Created by write_sdc on Sat May 11 19:41:00 2024
...
set_clock_transition -max -rise 0.2 [get_clocks wb_clk_i]
set_clock_transition -max -fall 0.2 [get_clocks wb_clk_i]
set_clock_transition -min -rise 0.2 [get_clocks wb_clk_i]
...
set_input_delay -clock V_Clk  -max 0.5  [get_ports wb_stb_i]
set_input_delay -clock wb_clk_i  -max 2  [get_ports wb_cyc_i]
set_input_delay -clock wb_clk_i  -max 2  [get_ports scl_pad_i]
set_input_delay -clock wb_clk_i  -max 2  [get_ports sda_pad_i]
set_input_delay -clock wb_clk_i  -max 2  [get_ports VDD]
set_input_delay -clock wb_clk_i  -max 2  [get_ports VSS]
...
set_output_delay -clock V_Clk  -max 0.5  [get_ports wb_ack_o]
set_output_delay -clock wb_clk_i  -max 2  [get_ports wb_inta_o]
set_output_delay -clock wb_clk_i  -max 2  [get_ports scl_pad_o]
set_output_delay -clock wb_clk_i  -max 2  [get_ports scl_padoen_o]
set_output_delay -clock wb_clk_i  -max 2  [get_ports sda_pad_o]
set_output_delay -clock wb_clk_i  -max 2  [get_ports sda_padoen_o]
